...
<li class="xn-icon-button pull-right" style="width:100">
    ...
    ?>                       
       ...
       <div class="page-content-wrap">
				     ...
				     <div class="form-horizontal">
			              <div class="panel panel-default">
							  ...
							  <?php
							   ...
							   {
                               ?>
							  ['<?php  echo $row['nomos']; ?>', 'New York',   '<?php  echo $row['username']; ?>' ],
                              <?php 
							    }
								?>
                               ]);
		...
		sizeAxis: {minValue: 1, maxValue:1,minSize:1,  maxSize: 1},
        icons: {
		  <?php
		  mysql_connect('localhost','root','') or die(mysql_error());
                               mysql_select_db('kep_new') or die(mysql_error());    
		...
		<?php  echo $row['username']; ?>: {
            normal: '<?php  echo $row['image_src']; ?>',
            selected: 'http://www.developer.com/imagesvr_ce/7616/GoogleMapsMarker_figure1.png',
          },     
		  <?php 
							    }
								?>
