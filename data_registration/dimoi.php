             ...
             <div class="col-md-12">
				     <div class="form-horizontal">
			              <div class="panel panel-default">
							   ...
							   <form action="dimoi.php" method="post">
Δήμος: <input type="text" name="dimos" /><br><br>
Νομός: <input type="text" name="nomos" /><br><br>
...
$sql="INSERT INTO dimoi_ellados (dimos, nomos)
VALUES
('$_POST[dimos]','$_POST[nomos]')";
...
$sql = "SELECT * FROM dimoi_ellados";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<br> id: ". $row["id"]. " - Name: ". $row["dimos"]. " " . $row["nomos"] . "<br>";
     }
} else {
     echo "0 results";
}
