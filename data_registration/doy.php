             ...
             <div class="col-md-12">
				     <div class="form-horizontal">
			              <div class="panel panel-default">
							   ...
							   <form action="doy.php" method="post">
Ονομασία Δ.Ο.Υ.: <input type="text" name="doy_name" /><br><br>
...
$sql="INSERT INTO doy_ellados (doy_name) VALUES ('$_POST[doy_name]')";
...
$sql = "SELECT * FROM doy_ellados";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<br> id: ". $row["id"]. " - Name: ". $row["doy_name"]."<br>";
     }
} else {
     echo "0 results";
}
